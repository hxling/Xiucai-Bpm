<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DemoUsers.aspx.cs" Inherits="Xiucai.BPM.Admin.demo.DemoUsers" %>
...
<!-- 工具栏按钮 -->
    ...
    <!-- 引入js文件 -->
      <script src="js/DemoUsers.js"></script>
</asp:Content>
