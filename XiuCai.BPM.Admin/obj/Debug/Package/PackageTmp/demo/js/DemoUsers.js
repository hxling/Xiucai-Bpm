var actionURL = '/demo/ashx/DemoUsersHandler.ashx';
var formurl   = '/demo/html/DemoUsers.html';
...
var grid = {
    bind: function (winSize) {
        $('#list').datagrid({
		    ...
		    {title:'企业',field:'Company',width:120},
		    {title:'所有者',field:'Ownner',width:120},
		    {title:'部门ID',field:'DepID',width:120}               
            ]],
            pagination: true,
            pageSize: PAGESIZE,
            pageList: [20, 40, 50]
...
var CRUD = {
    ...
    edit: function () {
        ...
        if (row) {
			...
			top.$('#txt_Company').val(row.Company);
			top.$('#txt_Ownner').val(row.Ownner);
			top.$('#txt_DepID').val(row.DepID);
			            },
                submit: function () {
                    if (top.$('#uiform').validate().form()) {
